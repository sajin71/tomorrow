...
class TestCPU extends AbstractCPU(new USB(), HashSet(new Add(), new Subst()), HashMap[String, Register](("r1"->new IntegerRegister()), ("r2"->new IntegerRegister()), ("r3"->new IntegerRegister())), 1024) {
